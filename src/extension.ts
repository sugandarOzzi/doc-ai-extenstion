        ...
        messages: [
          {
            role: "system",
            content:
              "You will be provided with a piece of code, and your task is to make it more human-readable with comments and also write a document for it at the bottom of the file.",
          },
          {
            role: "user",
            content: inputValue,
