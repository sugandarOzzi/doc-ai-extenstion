...
function activate(context) {
    ...
    let docCreate = vscode.commands.registerCommand("doc-ai.createDocumentation", async () => {
        try {
            ...
            await vscode.window.withProgress({
                ...
                try {
                    ...
                    if (editor) {
                        ...
                        const response = await handleOpenAPICall(entireText);
            ...
            console.error("Error fetching data from API:", error);
            vscode.window.showErrorMessage("Error fetching data from API. Please check the console for details.");
        }
    });
